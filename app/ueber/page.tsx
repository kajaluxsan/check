    ...
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <Step num="1" title="Adresse eingeben">
            Gib deine Adresse, die Zimmerzahl und die monatliche Nettomiete ein.
          </Step>
          <Step num="2" title="Analyse erhalten">
            checkmiete analysiert sechs Aspekte deiner Wohnung — von der
            Preisfairness bis zum nächsten ÖV-Anschluss.
          </Step>
          <Step num="3" title="Handeln">
            Auf Basis der Ergebnisse kannst du verhandeln, anfechten oder
            einfach sicher sein, dass dein Preis stimmt.
          </Step>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <Promise title="Gratis">
            Kein Abo, kein Premium, keine versteckten Kosten. Heute nicht, morgen nicht.
          </Promise>
          <Promise title="Ohne Login">
            Keine Registrierung, keine E-Mail, keine Cookies. Einfach nutzen.
          </Promise>
          <Promise title="Unabhängig">
            Wir sind kein Vermieter-Portal. Wir verdienen nichts an Inseraten.
          </Promise>
          <Promise title="Transparent">
            Alle Daten stammen aus öffentlichen Quellen. Jede Karte zeigt ihre Quelle.
          </Promise>
        </div>
      </section>
      ...
      {/* Datenquellen — bewusst dezent am Ende */}
      <details className="mt-16 text-sm">
        ...
        <div className="mt-4 rounded-2xl bg-ink-elev border border-ink-border p-5 text-ink-mute space-y-2">
          ...
          <p className="pt-2 text-ink-dim text-xs">
            Alle Daten sind öffentlich zugänglich. checkmiete speichert
            keine personenbezogenen Daten. Alle Berechnungen laufen lokal
            im Browser.
          </p>
        </div>
      </details>
